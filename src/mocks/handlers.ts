...
export const handlers = [
  // GET /api/sequences/templates - Get sequence templates (MUST be before :id route)
  ...
  // GET /api/sequences/:id/performance - Get sequence performance (before :id)
  ...
  // GET /api/sequences/:id/analytics - Get sequence analytics (before :id)
  ...
  // POST /api/sequences/:id/enroll - Enroll leads in a sequence (before generic :id)
